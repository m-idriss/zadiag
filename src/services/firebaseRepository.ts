...
import {
  ...
  parsePhotoChecklistItemResults,
...
const asEvent = (id: string, data: DocumentData): VerificationEvent => ({
  ...
  routineSourceDraftId: typeof data.routineSourceDraftId === 'string' ? data.routineSourceDraftId : undefined,
  routineSourceRevision: Number.isSafeInteger(data.routineSourceRevision) ? Number(data.routineSourceRevision) : undefined,
  routineSourceVersion: Number.isSafeInteger(data.routineSourceVersion) ? Number(data.routineSourceVersion) : undefined,
  ...
  photoChecklistItems: parsePhotoChecklistItemResults(data.photoChecklistItems),
  status: data.status,
  analysisSource: data.analysisSource,
  analysisProvider: typeof data.analysisProvider === 'string' ? data.analysisProvider : undefined,
  analysisModel: typeof data.analysisModel === 'string' ? data.analysisModel : undefined,
  analysisPromptVersion: typeof data.analysisPromptVersion === 'string' ? data.analysisPromptVersion : undefined,
