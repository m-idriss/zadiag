...
const messages = {
  en: {
    ...
    switchUser: 'Open other test user',
    switchUserHint: 'Switch between two separate sessions on this device without disconnecting or deleting either user.',
  ...
  fr: {
    ...
    switchUser: 'Ouvrir l’autre utilisateur de test',
    switchUserHint: 'Alterner entre deux sessions distinctes sur cet appareil sans déconnecter ni supprimer aucun utilisateur.',
