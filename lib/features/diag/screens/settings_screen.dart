...
import 'package:zadiag/shared/components/app_section.dart';
import 'package:zadiag/shared/components/app_switch.dart';
import 'package:zadiag/shared/components/app_divider.dart';
  ...
  Widget _deleteAccountCard(BuildContext context) {
    ...
    return GlassContainer(
      ...
      child: AppListTile(
        ...
        title: trad(context)!.delete_account,
        trailing: Icon(
          Icons.arrow_forward_ios_rounded,
          color: Colors.red,
          size: 18,
  ...
  Widget _notificationCard(BuildContext context) {
    ...
    return GlassContainer(
      ...
      child: AppListTile(
        ...
        title: trad(context)!.notifications,
