...
void _calendarEventSerialize(
  ...
  writer.writeLongList(offsets[6], object.reminders);
...
CalendarEvent _calendarEventDeserialize(
  ...
  final object = CalendarEvent(
    ...
    isAllDay: reader.readBoolOrNull(offsets[4]) ?? false,
    location: reader.readStringOrNull(offsets[5]),
    reminders: reader.readLongList(offsets[6]) ?? const [],
    title: reader.readStringOrNull(offsets[8]) ?? '',
  );
  object.endDateTime = reader.readDateTime(offsets[1]);
  object.startDateTime = reader.readDateTime(offsets[7]);
  return object;
}
...
extension CalendarEventQueryFilter
  ...
  QueryBuilder<CalendarEvent, CalendarEvent, QAfterFilterCondition>
      remindersElementEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
